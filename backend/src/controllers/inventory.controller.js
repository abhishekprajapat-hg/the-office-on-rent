...
const toLegacyAsset = (inventory, role) => {
  ...
  const asset = {
    ...
    depositMonths: inventory.depositMonths ?? null,
    agreementYears: inventory.agreementYears ?? null,
    lockInYears: inventory.lockInYears ?? null,
    officeNumber: inventory.officeNumber || "",
    ownerName: inventory.ownerName || "",
    ownerNumber: inventory.ownerNumber || "",
    ownerWhatsappNumber: inventory.ownerWhatsappNumber || "",
    ownerType: inventory.ownerType || "",
    keyManagerName: inventory.keyManagerName || "",
    keyManagerNumber: inventory.keyManagerNumber || "",
    dealType: inventory.dealType || "",
    propertyDate: inventory.propertyDate ?? null,
    ...
    superBuiltUpArea: inventory.superBuiltUpArea ?? null,
    length: inventory.length ?? null,
    width: inventory.width ?? null,
    ...
    documentsAvailable: inventory.documentsAvailable || null,
